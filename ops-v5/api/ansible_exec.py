...
def ansible_exec(module,args,host):
	import json
	...
	options = Options(connection='smart', module_path='/usr/lib/python2.7/site-packages/ansible/modules/', forks=100, become=None, become_method=None, become_user='root', check=False)
